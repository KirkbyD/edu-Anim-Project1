...
public:
	...
	void SetPosition(glm::vec3 positionIn) { this->TransformComponent->setPosition(positionIn); }
	void MutatePosition(glm::vec3 movement) { this->TransformComponent->MutatePosition(movement); }
	void SetOrientation(glm::quat orientationIn) { this->TransformComponent->setOrientation(orientationIn); }
